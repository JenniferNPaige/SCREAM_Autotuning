...
Training:
  ...
  using the same preprocessing steps as Final_Surrogate_Preprocessing-2.ipynb.
...
save_dir     = '/global/cfs/cdirs/e3sm/jpaige3/ESEm/CV_Saved_Model_Data_masked/GP_gridcell'
...
for seed_offset in range(N_SEEDS):
    ...
    for k, (train_index, test_index) in enumerate(kf.split(ppe_params)):
        ...
        gp_r2_file = os.path.join(
            save_dir, 'GP',
            f"GP_gridcell_r2output_varweight_seed={seed}_k={k}_{timestamp}.json"
        )
